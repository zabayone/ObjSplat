...
class Splat extends Element {
    ...
    get label() {
        return this.splatData.getProp('label') ?? this.splatData.getProp('labels') ?? (this.splatData as any).__label ?? (this.splatData as any).__labels ?? null;
    }
    ...
    onPreRender() {
        ...
        const isolateObject = objectMode && selected && this.numSelected > 0;

        this.entity.enabled = this.visible && (!objectMode || selected);
        ...
        material.setParameter('unselectedClr', isolateObject ? [0, 0, 0, 0] : [unselectedClr.r, unselectedClr.g, unselectedClr.b, unselectedClr.a]);
