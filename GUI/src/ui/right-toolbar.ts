...
class RightToolbar extends Container {
    constructor(events: Events, tooltips: Tooltips, args = {}) {
        ...
        const objectPanel = new Button({
            id: 'right-toolbar-object-panel',
            class: 'right-toolbar-toggle',
            text: 'OBJ'
        });
        ...
        tooltips.register(objectPanel, 'Object mode', 'left');
        ...
        objectPanel.on('click', () => events.fire('objectPanel.toggleVisible'));
        ...
        events.on('objectPanel.visible', (visible: boolean) => {
            objectPanel.class[visible ? 'add' : 'remove']('active');
        });
