...
def make_bagel_mask(mask_path, mask_smooth_path):
    ...
    # In alcuni run MPS la smooth mask viene salvata a meta risoluzione.
    # Riallineiamo alla mask principale per evitare errori di broadcasting.
    if mask2.size != mask.size:
