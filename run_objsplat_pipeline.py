...
from generate_layer_data import generate_layer_data
...
def _load_full_scene_refine_frames(input_root: Path) -> list[dict]:
    frames_dir = input_root / "traindata" / "perspective_frames" / "frames"
...
def main() -> None:
    ...
    parser.add_argument("--global_refine_iters", type=int, default=120)
